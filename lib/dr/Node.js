...
define(function(require, exports, module) {
    ...
    module.exports = dr.Node = new JS.Class('Node', {
        ...
        extend: {
            ...
            /** Creates a new child node of this node.
                ...
                @returns The new child or undefined if the child could not
                    be created. */
            createChild: function(parent, attrs, mixins) {
                ...
                if (typeof klass === 'function') {
                    ...
                    if (children) {
                        for (var i = 0, len = children.length; len > i; i++) instance.createChild(children[i]);
                    }
                    return instance;
                } else {
        ...
        createChild: function(attrs, mixins) {
            return dr.Node.createChild(this, attrs, mixins);
        },
