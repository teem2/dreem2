...
define(function(require, exports){
    ...
    dr.Node = new JS.Class('Node', {
            ...
            if (mixins) {
                ...
                for (; len > i;) {
                    ...
                    if (mixin) {
                        ...
                        dr.sprite.console.warn("Undefined mixin in initialization of: " + this.klass.__displayName);
                    }
                }
            }
        ...
        initNode: function(parent, attrs) {
            ...
            this.__allowPlacement = false; // Prevent children defined in class from using placement.
            this.__makeChildren(dr); // TAG:Global Scope
            this.__allowPlacement = true;
        ...
        createChild: function(attrs, mixins) {
            ...
            // Convert tagnames to classnames for builtin classes
            // FIXME: eventually we should just lowercase the built in classes.
            if (classname === 'node') {
                classname = 'Node';
        ...
        determinePlacement: function(placement, subnode) {
            if (!this.__allowPlacement) return this;
        ...
        __addNameRef: function(node) {
            ...
            if (this[name] === undefined) {
                ...
                dr.sprite.console.log("Name in use:" + name);
            }
        },
        ...
        __removeNameRef: function(node) {
            ...
            if (this[name] === node) {
                ...
                dr.sprite.console.log("Name not in use:" + name);
            }
        },
        ...
        animate: function(attr, to, from, relative, callback, duration, reverse, repeat, easingFunction) {
        ...
        getActiveAnimators: function(filterFunc) {
            if (typeof filterFunc === 'string') {
                ...
                filterFunc = function(anim) {return anim.prop === attrName;};
            }
