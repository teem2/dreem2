/** A single node within a tree data structure. A node has zero or one parent 
    ...
    Attributes:
        ...
        Lifecycle Related:
            initing:boolean (read only) Set to true during initialization and
                then false when initialization is complete.
            inited:boolean (read only) Set to true after this Node has 
    ...
    module.exports = dr.Node = new JS.Class('Node', {
        ...
        createChild: function(attrs, mixins) {
            ...
            if (attrs) {
                ...
                if (attrs.with) {
                    ...
                    attrs.with.split(dr.SEPARATOR_REGEX).forEach(
                        function(mixinName) {
            ...
            klass = dr.lookupClass(classname);
        ...
        __addNameRef: function(node) {
            ...
            if (this[name] === undefined) {
                ...
                dr.sprite.console.warn("Name in use:" + name);
            }
        },
        ...
        __removeNameRef: function(node) {
            ...
            if (this[name] === node) {
                ...
                dr.sprite.console.warn("Name not in use:" + name);
            }
        },
