...
define(function(require, exports, module){
	...
	var evaluatorlib = require('$SPRITE/expressionresolver.js' );
	var evaluator = new evaluatorlib();
	console.log("evaluator:");
	console.dir( evaluator);
	console.log("evaluatorlib:");
	console.dir(evaluatorlib);
    dr.AccessorSupport = new JS.Module('AccessorSupport', {
        ...
        bindConstraint: function(attrName, expression, isAsync) {
            ...
            var fn = (new Function('event','dr','this.setAttribute("' + attrName + '",' + evaluator.parse(expression )+ ', true)')).bind(this); // TAG:Global Scope
