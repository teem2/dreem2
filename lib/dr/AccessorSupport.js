...
define(function(require, exports, module){
    ...
    var evaluator = require('$SPRITE/expressionresolver.js' );
    ...
    dr.AccessorSupport = new JS.Module('AccessorSupport', {
                ...
                switch (type) {
                    case 'number':
                        ...
                        if (isNaN(value)) {
                            if (defaultValue !== undefined) {
                                ...
                                dr.dumpStack("NaN encountered parsing value as number with no default: " + value);
                            }
                        }
                        break;
                    case 'positivenumber':
                    ...
                    case 'json':
                        try {
                            ...
                            dr.global.error.logError("error parsing json value '" + value + "' for attribute '" + attrName + "'");
                        }
                        break;
                    case 'expression':
                        if (typeof value === 'string') {
                            value = (new Function('return ' + value)).bind(scope)();
                        }
                        break;
                    case '*':
                    case 'object':
        ...
        setConstraint: function(attrName, expression) {
            this.setAttribute(attrName, '${' + expression + '}');
            return this;
        },
        ...
        bindConstraint: function(attrName, expression, isAsync) {
            ...
            var fn = (new Function('event','dr','this.setAttribute("' + attrName + '",' + expression+ ', true)')).bind(this); // TAG:Global Scope
    ...
    module.exports = dr.AccessorSupport;
});
