define(function(require, exports){
	var exp = 
	{
		...
		ViewRect: function(rectactor, textactor, rectshader)
		{
			...
			this.ActorMap[this.GUID] = this;

			this.rectactor = rectactor;
			this.rectactor.name = this.GUID;
			this.rectshader = rectshader;
			this.textactor = textactor;
			this.textactor.name = this.GUID;
			...
			this.ClickCallbackCatch = function(source, val)
			{
				log(source.name);
				var target = ActorMap[source.name];
				if (target === undefined)
				{
			...
			this.setTopBorderWidth    = function(width){};
			this.setLeftBorderWidth   = function(width){};
			this.setBottomBorderWidth = function(width){};
			this.setRightBorderWidth  = function(width){};
			
			this.setBorderColorUniform = function(prefix, color){};
			this.setTopBorderColor     = function(color){this.setBorderColorUniform("top", color);};
			this.setLeftBorderColor    = function(color){this.setBorderColorUniform("top", color);};
			this.setBottomBorderColor  = function(color){this.setBorderColorUniform("top", color);};
			this.setRightBorderColor   = function(color){this.setBorderColorUniform("top", color);};

			this.setBorderStyleUniform = function(prefix, style){};
			this.setTopBorderStyle     = function(style){this.setBorderStyleUniform("top", style);};
			this.setLeftBorderStyle    = function(style){this.setBorderStyleUniform("left", style);};
			this.setBottomBorderStyle  = function(style){this.setBorderStyleUniform("bottom", style);};
			this.setRightBorderStyle   = function(style){this.setBorderStyleUniform("right", style);};

			this.setCornerRadiusUniform     = function(prefix, radius){};
			this.setTopLeftCornerRadius     = function(radius) {this.setCornerRadiusUniform("topleft", radius);};
			this.setBottomLeftCornerRadius  = function(radius) {this.setCornerRadiusUniform("bottomleft", radius);};
			this.setTopRightCornerRadius    = function(radius) {this.setCornerRadiusUniform("topright", radius);};
			this.setBottomRightCornerRadius = function(radius) {this.setCornerRadiusUniform("bottomright", radius);};

			// not sure if this should be handled here or by the unified view logic? probably better there... 
			this.setPadding       = function(padding){};
			this.setLeftPadding   = function(padding){};
			this.setRightPadding  = function(padding){};
			this.setBottomPadding = function(padding){};
			this.setTopPadding    = function(padding){};
		},
		...
		CreateView: function(x,y,width,height) 
		{
			...
			var R = new this.ViewRect(rect, t1, rectshader);	
			return R;
		},
