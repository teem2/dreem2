...
define(function(require, exports){
    ...
    var GlobalFocus = require('./GlobalFocus.js');
    var GlobalKeys = require('$SPRITE/GlobalKeys.js');
    var globalsprite = require('$SPRITE/global.js');	
    var GlobalRefs = require('$LIB/dr/globals/Global.js');
    ...
    new JS.Singleton('GlobalKeys', {
        ...
        initialize: function() {
            ...
            this.listenTo(GlobalRefs.focus, 'onfocused', '__handleFocused');
            ...
            GlobalRefs.register('keys', this);
        },
        
        createSprite: function(attrs) {
            return new GlobalKeys(this, attrs);
        },
