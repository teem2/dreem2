...
define(function(require, exports){
    ...
    new JS.Singleton('GlobalError', {
        ...
        notify: function(consoleFuncName, eventType, msg, err) {
            ...
            if (this.consoleLogging && consoleFuncName) dr.sprite.console[consoleFuncName](stacktrace || msg);
        },
        ...
        log: function(consoleFuncName, msg) {
            if (this.consoleLogging && consoleFuncName) dr.sprite.console[consoleFuncName](msg);
        }
    });
});
