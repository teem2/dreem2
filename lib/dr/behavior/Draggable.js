...
define(function(require, exports, module) {
    ...
    module.exports = dr.Draggable = new JS.Module('Draggable', {
        include: [
        ...
        __doMouseDown: function(event) {
            var pos = sprite.MouseObservable.getMouseFromEvent(event),
        ...
        updateDrag: function(event) {
            this.__requestDragPosition(sprite.MouseObservable.getMouseFromEvent(event));
        },
