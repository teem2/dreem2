...
/**
  ...
  * amount, index 3 is the spread and index 4 is the color. Index 5 determines
  * if the box shadow is inset or not. Each entry in the array is optional and 
  * the values default to: [0, 0, 4, 0, 'rgba(0,0,0,0.5)', false]
  */
