...
define(function(require, exports, module) {
    ...
    module.exports = dr.View = new JS.Class('View', dr.Node, {
        ...
        // Editor Support //
        __layoutDomainInUseForView: function(domain, subview) {
            var layouts = this.getLayouts(), i = layouts.length, layout;
            while (i) {
                layout = layouts[--i];
                if (layout.hasSubview(subview) && layout.__getLayoutDomains()[domain]) return true;
            }
            return false;
        }
    });
