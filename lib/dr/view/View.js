/** A Node that is a visual component on a screen.
    ...
    Attributes:
        ...
        Visual Related:
            ...
            gradient:array Sets a linear gradient fill on the view.
...
define(function(require, exports, module){
    ...
    module.exports = dr.View = new JS.Class('View', dr.Node, {
        ...
        setAttribute: function(attrName, value, isActual) {
            if (isActual) {
                return this.callSuper(attrName, value, isActual);
            } else {
                var constraint;
                switch (attrName) {
                    case 'x':
                ...
                if (constraint !== dr.noop) {
                    return this.callSuper(attrName, constraint !== undefined ? constraint : value, isActual);
                } else {
                    return this;
                }
            }
        ...
        set_topborder: function(v) {
            if (this.setActual('topborder', v, 'positivenumber', 0) && !this.__lockRecalc) {
                this.__updateBorder();
                this.__updateInnerHeight();
            }
        },
        ...
        set_bottomborder: function(v) {
            if (this.setActual('bottomborder', v, 'positivenumber', 0) && !this.__lockRecalc) {
                this.__updateBorder();
                this.__updateInnerHeight();
            }
        },
        ...
        set_leftborder: function(v) {
            if (this.setActual('leftborder', v, 'positivenumber', 0) && !this.__lockRecalc) {
                this.__updateBorder();
                this.__updateInnerWidth();
            }
        },
        ...
        set_rightborder: function(v) {
            if (this.setActual('rightborder', v, 'positivenumber', 0) && !this.__lockRecalc) {
                this.__updateBorder();
                this.__updateInnerWidth();
            }
        },
        ...
        set_toppadding: function(v) {
            if (this.setActual('toppadding', v, 'positivenumber', 0) && !this.__lockRecalc) {
        ...
        set_bottompadding: function(v) {
            if (this.setActual('bottompadding', v, 'positivenumber', 0) && !this.__lockRecalc) {
                this.__updatePadding();
                this.__updateInnerHeight();
            }
        },
        ...
        set_leftpadding: function(v) {
            if (this.setActual('leftpadding', v, 'positivenumber', 0) && !this.__lockRecalc) {
                this.__updatePadding();
                this.__updateInnerWidth();
            }
        },
        ...
        set_rightpadding: function(v) {
            if (this.setActual('rightpadding', v, 'positivenumber', 0) && !this.__lockRecalc) {
                this.__updatePadding();
                this.__updateInnerWidth();
            }
        },
        ...
        set_topleftcornerradius: function(v) {
            if (this.setActual('topleftcornerradius', v, 'positivenumber', 0) && !this.__lockRecalc) {
                this.__updateCornerRadius();
            }
        },
        
        set_toprightcornerradius: function(v) {
            if (this.setActual('toprightcornerradius', v, 'positivenumber', 0) && !this.__lockRecalc) {
                this.__updateCornerRadius();
            }
        },
        
        set_bottomleftcornerradius: function(v) {
            if (this.setActual('bottomleftcornerradius', v, 'positivenumber', 0) && !this.__lockRecalc) {
                this.__updateCornerRadius();
            }
        },
        
        set_bottomrightcornerradius: function(v) {
            if (this.setActual('bottomrightcornerradius', v, 'positivenumber', 0) && !this.__lockRecalc) {
                this.__updateCornerRadius();
            }
        },
        ...
        isBehind: function(view) {
            if (view && view.isA(dr.View)) {
                return this.sprite.isBehind(view);
            } else {
                return false;
            }
        },
        ...
        isInFrontOf: function(view) {
            if (view && view.isA(dr.View)) {
                return this.sprite.isInFrontOf(view);
            } else {
                return false;
            }
        },
