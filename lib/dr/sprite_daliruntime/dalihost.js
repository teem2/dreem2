...
//            return "./compositions/" + filename;            
        ...
        this.CreateView = function(x, y, width, height) {
            ...
            R.resolveResourceFile = function(filename){
                var mappedfile = define.COMPOSITIONROOT + filename;
            //    console.log("resolved resource "+filename+" to ", mappedfile)
                return mappedfile;
            }
            ...
            R.loadBitmap = function(filename){
                ...
                var resolvedimage = this.resolveResourceFile(filename);
            ...
            R.rectactor.anchorPoint = dali.CENTER;
            R.rectactor.parentOrigin = dali.TOP_LEFT;
            R.rectactor.position = [width / 2, height / 2, 1];
            ...
            R.rebuildText = function() {
                ...
                t1.positionX = -100;
                t1.positionY = -100;
                //console.log("text", t1.text,"this.fontsize:", this.fontsize, "pointsize:", this.fontsize * dali.stage.getDpi().x / 72.0);
                t1.pointSize =25;// fontInfo.pointSize;
                t1.name = this.GUID;
