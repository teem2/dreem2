...
define(function(require, exports, module) {
    ...
    var sprite = module.exports = dr.sprite = {
        ...
        storeGlobal: function(newId, oldId, obj) {
            ...
            console.log("storeglobal", newId, oldId);
            if (dict[oldId] === obj) {
        ...
        addEventListener: function() {
            if (globalScope.addEventListener) {
                ...
                return function(elem, type, callback) {
					...
					if (elem == undefined) elem = globalScope;
					//{
				...
				//	}
				//	else{
				//		console.log("no element for:", type);
				//	}
                };
            }
        }(),
        ...
        __isDomElementVisible: function(elem) {
            ...
            var style, document = globalScope;
            while (elem) {
        ...
        sendReadyEvent: function() {
            var event = globalScope.createEvent('Event')
