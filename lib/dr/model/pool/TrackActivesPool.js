...
define(function(require, exports, module){
    ...
    dr.TrackActivesPool = new JS.Class('TrackActivesPool', require('./SimplePool.js'), {
        // Life Cycle //////////////////////////////////////////////////////////////
        ...
        putInstance: function(obj) {
            ...
            if (actives) {
                ...
                dr.sprite.console.warn("Attempt to putInstance for a non-active instance.", obj, this);
            } else {
                dr.sprite.console.warn("Attempt to putInstance when no actives exist.", obj, this);
            }
        },
    ...
    module.exports = dr.TrackActivesPool;
});
