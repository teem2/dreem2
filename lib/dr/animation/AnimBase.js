    ...
    module.exports = dr.AnimBase = new JS.Class('AnimBase', require('$LIB/dr/Node.js'), {
        ...
        get_reverse: function() {
            ...
            if (this.parent && this.parent.isA(dr.AnimBase)) {
                if (reverse) {
                    return !this.parent.get_reverse();
                } else {
                    return this.parent.get_reverse();
                }
            }
        ...
        /** @private */
        reset: function() {
            this.__loopCount = this.getAttribute('reverse') && this.repeat > 0 ? this.repeat - 1 : 0;
        ...
        __isFlipped: function() {
            return (this.bounce && this.__loopCount % 2 !== 0) !== this.getAttribute('reverse');
        },
        ...
        __advance: function(timeDiff) {
            if (this.running && !this.paused) {
                ...
                if (target) {
                    this.updateTarget(target, this.__progress, oldProgress);
        ...
        updateTarget: function(target, progress, oldProgress) {
