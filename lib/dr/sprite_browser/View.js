    ...
    dr.sprite.View = new JS.Class('sprite.View', {
        ...
        moveToFront: function() {
            var po = this.platformObject,
                ppo =  po.parentNode;
            if (ppo && po !== ppo.lastChild) ppo.appendChild(po);
        },
        ...
        moveToBack: function() {
            var po = this.platformObject,
                ppo =  po.parentNode;
            if (ppo && po !== ppo.firstChild) ppo.insertBefore(po, ppo.firstChild);
        },
        ...
        moveBehind: function(otherView) {
            ...
            if (ppo && opo && opo.parentNode === ppo) ppo.insertBefore(po, opo);
        }
    });
