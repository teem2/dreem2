...
define(function(require, exports, module){
    ...
    dr.sprite.VideoPlayer = new JS.Class('sprite.VideoPlayer', require('./View.js'), {
        ...
        createPlatformMethodRef: function(platformObserver, methodName, eventType) {
            return this.createStandardPlatformMethodRef(platformObserver, methodName, eventType, dr.sprite.VideoPlayer) || 
                this.callSuper(platformObserver, methodName, type);
        }
    });
    
    module.exports = dr.sprite.VideoPlayer;
});
