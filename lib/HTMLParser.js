...
define(function(require, exports, module){
	 ...
	 */
	self.reserialize = function(node, spacing, indent){
	...
	self.onError = function(message, where){
	...
	self.onText = function(value, start){
	...
	self.onComment = function(value, start, end){
	...
	self.onCDATA = function(value, start, end){
	...
	self.onProcess = function(value, start, end){
	...
	self.onTagBegin = function(name, start, end){
	...
	self.onTagEnd = function(start, end){
	...
	self.onClosingTag = function(name, start, end){
		this.last_attr = undefined
	...
	self.onAttrValue = function(val, start, end){
	...
	self.processEntities = function(value, start){
